...
class monthly_attendance extends Controller
{
    public function index(Request $request)
    {
       ...
       $attendance_info =confirmattendances::join('employees', 'confirmattendances.emId', '=', 'employees.id')
        ...
        return view('attendance.monthly_attendance_list', compact('attendance_info','employee_info', 'designation_info', 'department_info','employeeId','designationId','departmentId','start_date', 'end_date'));
    }
