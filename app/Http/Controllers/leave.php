...
class Leave extends Controller
{
    public function index()
    {
        ...
        return view('leavetypes.leave.leave_list', compact('leave'));
    }

    public function add_leave()
    {
        return view('leavetypes.leave.add_leave');
    }
    ...
    public function edit_leave(Request $request, $id)
    {
        ...
        return view('leavetypes.leave.edit_leave', compact('leave_info'));
    }
    ...
    {
        $leave_info = leavetypes::findOrFail($id);
        return view('leavetypes.leave.view_leave', compact('leave_info'));
    }
