                    ...
                    <form method="post" action="{{ route('update_shift') }}" onsubmit="return validateForm()">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control" id="startTime" name="startTime" placeholder="Enter Start Time" value="{{ $shift_info->startTime }}">
                                <p id="startTimeError" class="text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="endTime">End Time</label>
                                <input type="text" autocomplete="off" class="form-control" id="endTime" name="endTime" placeholder="Enter End Time" value="{{ $shift_info->endTime }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control" id="toShift" name="toShift" placeholder="Enter To Shift" value="{{ $shift_info->toShift }}">
                                <p id="toShiftError" class="text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="intimeRange">In-time Range</label>
                                <input type="text" autocomplete="off" class="form-control" id="intimeRange" name="intimeRange" placeholder="Enter In-time Range" value="{{ $shift_info->intimeRange }}">
                                <p id="intimeRangeError" class="text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="outtimeRange">Out-time Range</label>
                                <input type="text" autocomplete="off" class="form-control" id="outtimeRange" name="outtimeRange" placeholder="Enter Out-time Range" value="{{ $shift_info->outtimeRange }}">
