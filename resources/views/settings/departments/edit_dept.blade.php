        ...
        <form method="post" action="{{ route('update_department') }}" onsubmit="return validateForm()">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" autocomplete="off" class="form-control" id="dept_name" name="dept_name" placeholder="Department Name" value="{{ $department_info->dept_name }}">
              <p id="dept_nameError" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="dep_description">Department Description</label>
              <input type="text" autocomplete="off" class="form-control" id="dep_description" name="dep_description" placeholder="Enter department description" value="{{ $department_info->dep_description }}">
              <p id="dep_descriptionError" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="dept_short_name">Department Short Name</label>
              <input type="text" autocomplete="off" class="form-control" id="dept_short_name" name="dept_short_name" placeholder="Enter Department Short Name" value="{{ $department_info->dept_short_name }}">
