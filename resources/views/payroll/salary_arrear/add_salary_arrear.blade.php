...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1 class="m-0">Add salary arrear</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
  ...
  <div class="row">
    ...
    <div class="col-md-12 m-auto">
      ...
      <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" action="{{ route('salary_arrear_add_action') }}" onsubmit="return validateForm()">
          @csrf
          <div class="card-body">
            <div class="d-flex">
            ...
            <div class="d-flex">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="number" class="form-control" id="payable_days" name="payable_days" placeholder="Enter payable_days" >
