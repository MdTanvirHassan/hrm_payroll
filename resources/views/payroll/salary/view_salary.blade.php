        ...
        <div class="row">
                    ...
                    <form method="post" action="{{ route('update_salary') }}" onsubmit="return validateForm()">
                        ...
                        <div class="d-flex">
                                <div class="form-group col-4">
                                    ...
                                    <select class="form-select form-control" id="employeeId" name="employeeId" required onchange="updateName()" disabled>
            ...
            <div class="d-flex">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="number" class="form-control" id="gross" name="gross" placeholder="Enter gross salary" value="{{ $salary_info->gross }}" readonly>
                        <p id="grossError" class="text-danger"></p>
                    </div>
                    <div class="form-group col-4">
                        <label for="others">Others Allowance</label>
                        <input type="number" class="form-control" id="others" name="others" placeholder="Enter Others Allowance" value="{{ $salary_info->Others }}" readonly>
                        <p id="othersError" class="text-danger"></p>
                    </div>

                      <div class="form-group col-4">
                        <label for="net_gross">Net Gross Benefit</label>
                        <input type="number" class="form-control" id="net_gross" name="net_gross" placeholder="Enter net gross benifit" value="{{ $salary_info->net_gross }}" readonly>
            ...
            <div class="d-flex">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="number" class="form-control" id="stamp" name="Stamp" placeholder="Enter stamp" value="{{ $salary_info->Stamp }}" readonly>
                        <p id="stampError" class="text-danger"></p>
                    </div>
                    <div class="form-group col-4">
                        <label for="tax">Tax</label>
                        <input type="number" class="form-control" id="tax" name="Tax" placeholder="Enter Tax" value="{{ $salary_info->Tax }}" readonly>
                        <p id="othersError" class="text-danger"></p>
                    </div>

                      <div class="form-group col-4">
                        <label for="security_amount">Security Amount</label>
                        <input type="number" class="form-control" id="security_amount" name="security_amount" placeholder="Enter security amount" value="{{ $salary_info->security_amount }}" readonly>
            ...
            <div class="d-flex">
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-select form-control" id="distribution_type" name='distribution_type' required disabled>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="number" class="form-control" id="bank_portion" name="bank_portion" placeholder="Enter Bank Amount" value="{{ $employee_bank_info->bank_portion	 }}" readonly>
                        <!-- <p id="othersError" class="text-danger"></p> -->
                    </div>

                      <div class="form-group col-4">
                        <label for="cash_portion">Cash</label>
                        <input type="number" class="form-control" id="cash_portion" name="cash_portion" placeholder="Enter Cash amount" value="{{ $employee_bank_info->cash_portion }}" readonly>
            ...
            <div class="d-flex">
                  ...
                  <div class="form-group col-4">
                      ...
                      <select class="form-select form-control" id="bank_id" name="bank_id" required disabled>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="number" class="form-control" id="bank_acct_no" name="bank_acct_no" placeholder="Enter Bank" value="{{ $employee_bank_info->bank_acct_no }}" readonly>
                        <!-- <p id="bank_acct_noError" class="text-danger"></p> -->
                    </div>

                      <div class="form-group col-4">
                        <label for="salary_held_up">Salary Held Up</label>
                        <select class="form-select form-control" id="salary_held_up" name='salary_held_up' required disabled>
